...
{   
    ...
    private:
        ...
        std::string homeDir = "";
        std::string packagePath = "Desktop/ReefRanger/robot/robot/src/ros2_orb_slam3/"; //! Change to match path to your workspace
	...
	rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr path_publisher_;
        ...
        std::vector<ORB_SLAM3::IMU::Point> RetrieveIMUData(double timeStep); 
