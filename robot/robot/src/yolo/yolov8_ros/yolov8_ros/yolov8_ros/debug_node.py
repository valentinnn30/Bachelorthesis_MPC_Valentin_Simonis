...
class DebugNode(LifecycleNode):
    ...
    def detections_cb(self, img_msg: Image, detection_msg: DetectionArray) -> None:
        ...
        for detection in detection_msg.detections:
            ...
            print(f"Processing detection {detection_count + 1}: {detection.class_name}, Score: {detection.score}")
            # random color
            label = detection.class_name
            ...
            save_path = os.path.join("/home/reefranger/Desktop/predictionsss", filename)
