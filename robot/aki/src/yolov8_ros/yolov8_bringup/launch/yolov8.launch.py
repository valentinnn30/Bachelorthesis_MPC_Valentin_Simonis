...
def generate_launch_description():
    ...
    os.path.dirname(__file__),  # the folder where your launch file is
    '..',
    '..',                       # go up two levels (to yolov8_ros)
    ...
    model_cmd = DeclareLaunchArgument(
        "model",
        #default_value="robot/aki/src/yolov8_ros/best.pt",
        default_value="/home/reefranger/Desktop/ReefRanger/robot/aki/src/yolov8_ros/best.pt",
