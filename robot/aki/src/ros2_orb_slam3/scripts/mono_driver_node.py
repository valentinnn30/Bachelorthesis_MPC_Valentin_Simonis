...
class MonoDriver(Node):
    def __init__(self, node_name = "mono_py_node"):
        ...
        self.home_dir = str(Path.home()) + "/home/reefranger/Desktop/ReefRanger/robot/aki/src/ros2_orb_slam3" #! Change this to match path to your workspace
        #self.home_dir = str(Path.home()) + "/ros2_test/src/ros2_orb_slam3" #! Change this to match path to your workspace
        #self.home_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'src', 'ros2_orb_slam3') # Set to the relative path of the working directory
    ...
    # ****************************************************************************************
    def run_py_node(self, frame, timestep):
        """
...
def main(args = None):
    ...
    try:
        ...
        #n.run_py_node(n.frame, n.timestamp)
        rate.sleep()
